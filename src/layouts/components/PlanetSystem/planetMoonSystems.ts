...
export const PLANET_MOON_SYSTEMS: Partial<Record<SpaceTheme, OrbitalMoonConfig[]>> = {
    ...
    saturn: [
        ...
        { centerY: SATURN_SCENE_CENTER_Y, glow: "rgba(232, 242, 255, 0.11)", key: "rhea", label: "Rhea", map: rheaMap, mapFilter: "saturate(0.78) contrast(1.04) brightness(1.02)", orbitDelay: "-102s", orbitDuration: "218s", orbitSize: "142rem", shadow: "rgba(60, 68, 82, 0.18)", shellEnd: "#aeb8c5", shellMid: "#dfe8f1", shellStart: "#fbfdff", size: "4.2rem", spinDuration: "194s", trackOpacity: "0.92" },
        { centerY: SATURN_SCENE_CENTER_Y, glow: "rgba(235, 240, 252, 0.1)", key: "dione", label: "Dione", map: dioneMap, mapFilter: "saturate(0.82) contrast(1.04) brightness(1.01)", orbitDelay: "-48s", orbitDuration: "254s", orbitSize: "158rem", shadow: "rgba(56, 62, 72, 0.18)", shellEnd: "#a8b0bb", shellMid: "#dde4ed", shellStart: "#f8fbff", size: "3.8rem", spinDuration: "228s", trackOpacity: "0.9" },
    ],
    uranus: [
        ...
        { ...icyMoon("titania", "Titania", EARTH_SCENE_CENTER_Y, "148rem", "4.4rem", "-132s"), map: titaniaMap },
    ],
    neptune: [
