...
export const PLANET_MOON_SYSTEMS: Partial<Record<SpaceTheme, OrbitalMoonConfig[]>> = {
    ...
    mars: [
        ...
        },
        {
            ...
            label: "Deimos",
            map: phobosMap,
            mapFilter: "saturate(0.72) contrast(1.04) brightness(0.92)",
            orbitDelay: "-102s",
            orbitDuration: "176s",
            orbitSize: "134rem",
    ...
    jupiter: [
        { centerY: JUPITER_SCENE_CENTER_Y, glow: "rgba(255, 198, 120, 0.12)", key: "io", label: "Io", map: ioMap, mapFilter: "saturate(1.08) contrast(1.08) brightness(0.98)", orbitDelay: "-14s", orbitDuration: "122s", orbitSize: "132rem", shadow: "rgba(84, 28, 8, 0.26)", shellEnd: "#8d4f2d", shellMid: "#d59054", shellStart: "#f8d37c", size: "4.1rem", spinDuration: "118s", trackOpacity: "0.95" },
        { centerY: JUPITER_SCENE_CENTER_Y, glow: "rgba(196, 224, 255, 0.14)", key: "europa", label: "Europa", map: europaMap, mapFilter: "saturate(0.9) contrast(1.08) brightness(1.02)", orbitDelay: "-52s", orbitDuration: "156s", orbitSize: "148rem", shadow: "rgba(44, 58, 82, 0.2)", shellEnd: "#96a4b6", shellMid: "#d9e1eb", shellStart: "#f7fbff", size: "3.7rem", spinDuration: "148s", trackOpacity: "0.92" },
        { centerY: JUPITER_SCENE_CENTER_Y, glow: "rgba(220, 234, 255, 0.12)", key: "ganymede", label: "Ganymede", map: ganymedeMap, mapFilter: "saturate(0.86) contrast(1.06) brightness(0.98)", orbitDelay: "-108s", orbitDuration: "204s", orbitSize: "166rem", shadow: "rgba(48, 44, 38, 0.24)", shellEnd: "#80756a", shellMid: "#b6aca3", shellStart: "#ece6df", size: "4.8rem", spinDuration: "188s", trackOpacity: "0.94" },
        { centerY: JUPITER_SCENE_CENTER_Y, glow: "rgba(210, 223, 239, 0.1)", key: "callisto", label: "Callisto", map: moonMap, mapFilter: "saturate(0.72) contrast(1.12) brightness(0.82)", orbitDelay: "-82s", orbitDuration: "246s", orbitSize: "184rem", shadow: "rgba(24, 22, 22, 0.28)", shellEnd: "#5b5651", shellMid: "#928980", shellStart: "#c8c0b7", size: "4.4rem", spinDuration: "214s", trackOpacity: "0.96" },
    ],
    saturn: [
        { centerY: SATURN_SCENE_CENTER_Y, glow: "rgba(255, 166, 94, 0.16)", key: "titan", label: "Titan", map: titanMap, mapFilter: "saturate(1.4) contrast(1.05) brightness(1.02)", orbitDelay: "-26s", orbitDuration: "138s", orbitSize: "110rem", shadow: "rgba(96, 42, 10, 0.22)", shellEnd: "#ac5a22", shellMid: "#ec983b", shellStart: "#ffbd6d", size: "5rem", spinDuration: "132s", trackOpacity: "0.9" },
        { centerY: SATURN_SCENE_CENTER_Y, glow: "rgba(245, 250, 255, 0.14)", key: "enceladus", label: "Enceladus", map: enceladusMap, mapFilter: "saturate(0.82) contrast(1.05) brightness(1.04)", orbitDelay: "-76s", orbitDuration: "174s", orbitSize: "126rem", shadow: "rgba(90, 110, 134, 0.16)", shellEnd: "#c3d1e4", shellMid: "#edf5fd", shellStart: "#ffffff", size: "3.2rem", spinDuration: "160s", trackOpacity: "0.88" },
        { centerY: SATURN_SCENE_CENTER_Y, glow: "rgba(232, 242, 255, 0.11)", key: "rhea", label: "Rhea", map: moonMap, mapFilter: "saturate(0.74) contrast(1.04) brightness(1.02)", orbitDelay: "-102s", orbitDuration: "218s", orbitSize: "142rem", shadow: "rgba(60, 68, 82, 0.18)", shellEnd: "#aeb8c5", shellMid: "#dfe8f1", shellStart: "#fbfdff", size: "4.2rem", spinDuration: "194s", trackOpacity: "0.92" },
        { centerY: SATURN_SCENE_CENTER_Y, glow: "rgba(235, 240, 252, 0.1)", key: "dione", label: "Dione", map: moonMap, mapFilter: "saturate(0.76) contrast(1.05) brightness(1.04)", orbitDelay: "-48s", orbitDuration: "254s", orbitSize: "158rem", shadow: "rgba(56, 62, 72, 0.18)", shellEnd: "#a8b0bb", shellMid: "#dde4ed", shellStart: "#f8fbff", size: "3.8rem", spinDuration: "228s", trackOpacity: "0.9" },
    ],
    uranus: [
        { ...icyMoon("miranda", "Miranda", EARTH_SCENE_CENTER_Y, "110rem", "3.2rem", "-22s"), map: mirandaMap },
        { ...icyMoon("ariel", "Ariel", EARTH_SCENE_CENTER_Y, "128rem", "3.6rem", "-76s"), map: arielMap },
        { ...icyMoon("titania", "Titania", EARTH_SCENE_CENTER_Y, "148rem", "4.4rem", "-132s"), map: moonMap, mapFilter: "saturate(0.68) contrast(1.08) brightness(0.98)" },
    ],
    neptune: [
        { ...icyMoon("triton", "Triton", EARTH_SCENE_CENTER_Y, "118rem", "4.5rem", "-54s"), map: tritonMap, mapFilter: "saturate(0.86) contrast(1.08) brightness(1.01)" },
        { ...icyMoon("nereid", "Nereid", EARTH_SCENE_CENTER_Y, "146rem", "2.6rem", "-120s"), bodyClipPath: irregularAsteroidShape, bodyScaleX: "1.26", bodyScaleY: "0.82", map: nereidMap },
    ],
    pluto: [
    ...
    makemake: [
        { ...icyMoon("mk2", "MK2", EARTH_SCENE_CENTER_Y, "66rem", "2rem", "-74s"), bodyClipPath: irregularAsteroidShape, bodyScaleX: "1.3", bodyScaleY: "0.8", map: moonMap, mapFilter: "saturate(0.52) contrast(1.18) brightness(0.58)", shellEnd: "#2f2728", shellMid: "#5f5554", shellStart: "#9b918d" },
    ],
    eris: [
        { ...icyMoon("dysnomia", "Dysnomia", EARTH_SCENE_CENTER_Y, "68rem", "2.4rem", "-64s"), bodyClipPath: irregularAsteroidShape, bodyScaleX: "1.24", bodyScaleY: "0.84", map: moonMap, mapFilter: "saturate(0.64) contrast(1.1) brightness(0.96)" },
    ],
};
