...
const ASTEROID_FOREGROUND_BOULDERS = [
    ...
    },
    {
        ...
        left: "7%",
        opacity: 0.82,
        radius: "53% 47% 66% 34% / 40% 60% 42% 58%",
        rotate: "-16deg",
        size: "28rem",
        top: "5%",
        variant: "colossal foreground",
        zIndex: 2,
    },
    {
        delay: "-33s",
        ...
        left: "25%",
        opacity: 0.72,
        radius: "46% 54% 60% 40% / 55% 37% 63% 45%",
        rotate: "19deg",
        size: "22rem",
        top: "48%",
        variant: "giant foreground",
    ...
    },
    {
        ...
        left: "43%",
        opacity: 0.78,
        radius: "62% 38% 48% 52% / 37% 61% 43% 59%",
        rotate: "-8deg",
        size: "24rem",
        top: "18%",
        variant: "giant foreground",
    ...
    },
    {
        ...
        left: "60%",
        opacity: 0.76,
        radius: "49% 51% 67% 33% / 54% 39% 61% 46%",
        rotate: "13deg",
        size: "26rem",
        top: "57%",
        variant: "giant foreground",
    ...
    },
    {
        ...
        left: "82%",
        opacity: 0.8,
        radius: "58% 42% 53% 47% / 39% 59% 41% 61%",
        rotate: "-21deg",
        size: "31rem",
        top: "8%",
        variant: "colossal foreground",
    ...
    },
    {
        ...
        left: "91%",
        opacity: 0.74,
        radius: "43% 57% 61% 39% / 52% 38% 62% 48%",
        rotate: "24deg",
        size: "42rem",
        top: "74%",
        variant: "colossal foreground edge",
